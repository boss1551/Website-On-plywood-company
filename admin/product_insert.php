 			 	...
 			 	<div class="grid-form">
 					<div class="grid-form1">
 						<h3 id="forms-example" class="">Add Product</h3>
							<form name="product_inset.php" action="" method="post" enctype="multipart/form-data">
		 						<div class="form-group">
									<input type="name" class="form-control" name="name" placeholder="Enter Product Name"><br>
									<input type="name" class="form-control" name="desc" placeholder="Enter product Description"><br>
...
if(isset($_REQUEST["submit"])==true)
{
	...
	{
		$cmd=mysql_query("insert into product(p_name,p_desc,p_img) values('$name','$desc','$image') ");
