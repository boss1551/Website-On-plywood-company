		...
		<div class="about-heading">
			<div class="container">
				<div class="contact-form">
					<h2 class="wow fadeInDown animated" data-wow-delay=".5s">User SignUp</h2><br>
						<form action="#" method="post">
							<input type="text" placeholder="Name" required=""><br>
							<input type="email" placeholder="Email" required=""><br><br>
							<input type="text" placeholder="Mobile Number" required=""><br>
							<input type="password" placeholder="password" required=""><br>
							<input type="password" placeholder="Re-type password" required=""><br>
							<button class="btn1 btn-1 btn-1b">Submit</button>
							<h5><p>Already have an account??<a href="login.php" style="text-decoration: none;">&nbsp;Click here for login</a></p></h5>
						</form>
				</div>
			</div>
		</div>
